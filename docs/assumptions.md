...
## A1: Cortico-Nuclear Mapping Based on Voogd Zonal Scheme
...
Sugihara & Shinoda 2007).

**Mapping rules applied:**

| Cerebellar cortical region | Target deep nucleus | Confidence |
|---|---|---|
| Vermis (lobules I-X midline) | Fastigial | High |
| Paravermal lobules I-V | Emboliform (ant. interposed) | Moderate |
| Paravermal lobules VI-IX | Globose (post. interposed) | Moderate |
| Lateral hemisphere, anterior lobe | Dentate (dorsal/motor domain) | High |
| Lateral hemisphere, Crus I/II | Dentate (ventral/nonmotor domain) | High |
| Lateral hemisphere, lobules VIIb-IX | Dentate (intermediate) | Moderate |
| Flocculonodular lobe (lobule X) | Fastigial + vestibular nuclei | High |
...
- `mean`: average pathway occupancy across lesion voxels (underestimates focal lesions)
